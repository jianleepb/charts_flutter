...
class NumericAxisSpec extends AxisSpec<num> {
  ...
  @override
  void configure(
      Axis<num> axis, ChartContext context, GraphicsFactory graphicsFactory, {bool needReset = true}) {
    super.configure(axis, context, graphicsFactory, needReset: needReset);
