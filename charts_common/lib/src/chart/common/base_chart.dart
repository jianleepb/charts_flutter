...
abstract class BaseChart<D> {
  ...
  /// series displaynames
  List<String> _seriesDisplaynames;
  ...
  List<String> getSeriesDisplaynames() {
    if (_seriesDisplaynames == null && _originalSeriesList != null) {
      _seriesDisplaynames = [];
      _originalSeriesList.forEach((element) {
        _seriesDisplaynames.add(element.displayName);
      });
    }
    return _seriesDisplaynames;
  }
