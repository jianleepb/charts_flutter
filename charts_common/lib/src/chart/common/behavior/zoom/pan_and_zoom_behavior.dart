...
class PanAndZoomBehavior<D> extends PanBehavior<D> {
  ...
  void setMaxScalingFactor(double maxScalingFactor) {
    this._maxScalingFactor = maxScalingFactor;
  }
  ...
  bool onDragUpdate(Point<double> localPosition, double scale) {
    ...
    double viewportTranslatePx = _localPosition.x * (1 - newScalingFactor);

    domainAxis.setViewportSettings(
        newScalingFactor, viewportTranslatePx,
